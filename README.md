...
This contains the Sprague-Grundy values (nimbers) for the 4-pile variant of the combinatorial game Princess and the Roses. 
  ...
  (0, -1, -1),
  (0, 0, -1).
  These positions are denoted as [x, y, z], with 0≤x≤y≤z.
  
The file positions_50.txt contains every position in this game with z≤50, along with their Sprague-Grundy values. 
  They are ordered by increasing value of z, then x, then y.
  
The file positions_sorted_fancy.html contains the nimbers of every position in this game with z≤50. The nimbers are sorted into pages 
